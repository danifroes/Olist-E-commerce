...
class Order:
    ...
    def get_wait_time(self, is_delivered=True):
        ...
        def handle_delay(x):
            # We only want to keep delay where wait_time is longer than expected
        ...
        return orders[['order_id', 'order_delivered_customer_date', 'wait_time', 'expected_wait_time',
    ...
    def get_number_products(self):
        ...
        products = self.data['order_items']\
            .groupby('order_id',as_index=False).agg({'order_item_id': 'count'})
    ...
    def get_distance_seller_customer(self):
        """
        Returns a DataFrame with order_id and distance between seller and customer
        """
        # Using the haversine_distance logic coded in olist/utils.py
